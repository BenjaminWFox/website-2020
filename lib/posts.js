...
const TEMP_CHECK = 'new-page-will-break'
const DATE_OPTIONS = {
  dateStyle: 'medium',
  // weekday: 'long',
  year: 'numeric',
...
function Post(filepath, filename, status, matterResult, processedContent) {
  ...
  const buildPathAndUrls = () => {
    ...
    this.dynamicPath.push(matterResult.data.category || null)
...
const makePost = async (filepath, filename, status) => {
  ...
  // if (filename.includes(TEMP_CHECK)) {
  //   console.log(matterResult)
  //   console.log(processedContent)

  //   const p = new Post(filepath, filename, status, matterResult, processedContent)
  ...
  // const dateLong = new Date(date).toLocaleDateString('en-US', DATE_OPTIONS)
  ...
  // dynamicPath.push(matterResult.data.category || null)
  // relativeUrl += `/${name}`
...
const getAllPostsFromFiles = () => {
  console.log('posts: getAllPostsFromFiles')
