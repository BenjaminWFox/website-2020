...
const buildPostData = async () => {
  ...
  const posts = await Promise.all([
    ...
    makePost(`${ROOT_CONTENT_DIR}${DRAFT_POSTS_DIR}/tech`, 'share-state-between-screens-custom-navigators-react-navigation.md', published),
    makePost(`${ROOT_CONTENT_DIR}${DRAFT_POSTS_DIR}/tech`, 'creating-react-component-library-abstracting-react-component-library.md', published),
